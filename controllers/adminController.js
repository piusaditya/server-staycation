...
module.exports = {
  ...
  deleteFeature: async (req, res) => {
    ...
    try {
      ...
      // delete image and remove from collection
      await fs.unlink(path.join(`public/${feature.imageUrl}`));
  ...
  actionConfirmation: async (req, res) => {
    ...
    try {
      ...
      await booking.save();
      req.flash("alertMessage", "Success Payment Confirmed");
      req.flash("alertStatus", "success");
  ...
  actionReject: async (req, res) => {
    ...
    try {
      ...
      await booking.save();
      req.flash("alertMessage", "Success Payment Rejected");
      req.flash("alertStatus", "success");
      res.redirect(`/admin/booking/${id}`);
    } catch (error) {
      res.redirect(`/admin/booking/${id}`);
