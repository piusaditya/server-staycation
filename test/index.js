...
describe("API ENDPOINT TESTING", () => {
  ...
  it("GET Detail Page", (done) => {
    chai
      .request(app)
      .get("/api/v1/member/detail-page/5e96cbe292b97300fc902230")
      .end((err, res) => {
        expect(err).to.be.null;
        expect(res).to.have.status(200);
        expect(res.body).to.be.an("object");
  ...
  it("POST Booking Page", (done) => {
    const image = __dirname + "/buktibayaran.jpeg";
    const dataSample = {
      image,
      idItem: "5e96cbe292b97300fc902230",
      duration: 3,
      bookingStartDate: "9-3-2021",
      bookingEndDate: "12-3-2021",
      firstName: "Love",
      lastName: "Quinn",
      email: "lovelikesfood@gmail.com",
      phoneNumber: "123314000",
      accountHolder: "Love Quinn",
      bankFrom: "Bank of America",
    };
    chai
      .request(app)
      ...
      .attach("image", fs.readFileSync(dataSample.image), "buktibayaran.jpeg")
      .end((err, res) => {
        expect(err).to.be.null;
